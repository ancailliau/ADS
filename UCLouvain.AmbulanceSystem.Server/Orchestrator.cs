...
namespace UCLouvain.AmbulanceSystem.Server
{
    public class Orchestrator
    {
        ...
        internal readonly AmbulanceStationRepository ambulanceStationRepository;
        ...
        public void Process(Message m)
        {
            try
            {
                ...
                else if (m is RegisterAmbulanceStation registerAmbulanceStation)
                {
                    RegisterAmbulanceStation(registerAmbulanceStation);
